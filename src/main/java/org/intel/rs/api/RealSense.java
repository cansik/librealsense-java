...
public class RealSense extends org.intel.rs.api.RealSenseLibraryConfig {
    static { Loader.load(); }

// Parsed from /Users/cansik/git/private/librealsense-java/librealsense/include/librealsense2/rs.h
...
public static final int RS2_API_MINOR_VERSION =    23;
...
public static final String RS2_API_VERSION_STR = RS2_API_MAJOR_VERSION + "." + RS2_API_MINOR_VERSION + "." + RS2_API_PATCH_VERSION;
...
public static native void rs2_log_to_console(rs2_log_severity min_severity, @Cast("rs2_error**") PointerPointer error);
public static native void rs2_log_to_console(rs2_log_severity min_severity, @ByPtrPtr rs2_error error);

public static native void rs2_log_to_file(rs2_log_severity min_severity, @Cast("const char*") BytePointer file_path, @Cast("rs2_error**") PointerPointer error);
public static native void rs2_log_to_file(rs2_log_severity min_severity, @Cast("const char*") BytePointer file_path, @ByPtrPtr rs2_error error);
public static native void rs2_log_to_file(rs2_log_severity min_severity, String file_path, @ByPtrPtr rs2_error error);
 ...
 * @param error [out]  if non-null, receives any error that occurs during this call, otherwise, errors are ignored
 */
public static native void rs2_log(rs2_log_severity severity, @Cast("const char*") BytePointer message, @Cast("rs2_error**") PointerPointer error);
public static native void rs2_log(rs2_log_severity severity, @Cast("const char*") BytePointer message, @ByPtrPtr rs2_error error);
public static native void rs2_log(rs2_log_severity severity, String message, @ByPtrPtr rs2_error error);
...
*/
public static native double rs2_get_time( @Cast("rs2_error**") PointerPointer error);
public static native double rs2_get_time( @ByPtrPtr rs2_error error);
...
// Parsed from /Users/cansik/git/private/librealsense-java/librealsense/include/librealsense2/rs_advanced_mode.h
...
// Parsed from /Users/cansik/git/private/librealsense-java/librealsense/include/librealsense2/rsutil.h
...
// Parsed from /Users/cansik/git/private/librealsense-java/librealsense/include/librealsense2/h/rs_advanced_mode_command.h
...
public static class STDepthControlGroup extends Pointer {
    static { Loader.load(); }
...
public static class STRsm extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
...
public static class STRauSupportVectorControl extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
...
public static class STColorControl extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
...
public static class STRauColorThresholdsControl extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
...
public static class STSloColorThresholdsControl extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
...
public static class STSloPenaltyControl extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
...
public static class STHdad extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
...
public static class STColorCorrection extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
...
public static class STAEControl extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
...
public static class STDepthTableControl extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
...
public static class STCensusRadius extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
...
public static class STAFactor extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
...
// Parsed from /Users/cansik/git/private/librealsense-java/librealsense/include/librealsense2/h/rs_config.h
...
// #include "rs_sensor.h"
    ...
    * @param error [out]  if non-null, receives any error that occurs during this call, otherwise, errors are ignored
    */
    public static native void rs2_config_disable_stream(rs2_config config, rs2_stream stream, @Cast("rs2_error**") PointerPointer error);
    public static native void rs2_config_disable_stream(rs2_config config, rs2_stream stream, @ByPtrPtr rs2_error error);
    ...
    * @param error [out]  if non-null, receives any error that occurs during this call, otherwise, errors are ignored
    */
    public static native void rs2_config_disable_indexed_stream(rs2_config config, rs2_stream stream, int index, @Cast("rs2_error**") PointerPointer error);
    public static native void rs2_config_disable_indexed_stream(rs2_config config, rs2_stream stream, int index, @ByPtrPtr rs2_error error);
...
// Parsed from /Users/cansik/git/private/librealsense-java/librealsense/include/librealsense2/h/rs_context.h
...
* @param error [out]  if non-null, receives any error that occurs during this call, otherwise, errors are ignored
*/
public static native void rs2_set_devices_changed_callback(@Const rs2_context context, @ByVal rs2_devices_changed_callback_ptr callback, Pointer user, @Cast("rs2_error**") PointerPointer error);
public static native void rs2_set_devices_changed_callback(@Const rs2_context context, @ByVal rs2_devices_changed_callback_ptr callback, Pointer user, @ByPtrPtr rs2_error error);
...
// Parsed from /Users/cansik/git/private/librealsense-java/librealsense/include/librealsense2/h/rs_device.h
...
*/
public static native @Cast("const char*") BytePointer rs2_get_device_info(@Const rs2_device device, rs2_camera_info info, @Cast("rs2_error**") PointerPointer error);
public static native @Cast("const char*") BytePointer rs2_get_device_info(@Const rs2_device device, rs2_camera_info info, @ByPtrPtr rs2_error error);
...
*/
public static native int rs2_supports_device_info(@Const rs2_device device, rs2_camera_info info, @Cast("rs2_error**") PointerPointer error);
public static native int rs2_supports_device_info(@Const rs2_device device, rs2_camera_info info, @ByPtrPtr rs2_error error);
...
*/
public static native int rs2_is_device_extendable_to(@Const rs2_device device, rs2_extension extension, @Cast("rs2_error**") PointerPointer error);
public static native int rs2_is_device_extendable_to(@Const rs2_device device, rs2_extension extension, @ByPtrPtr rs2_error error);
...
// Parsed from /Users/cansik/git/private/librealsense-java/librealsense/include/librealsense2/h/rs_frame.h
...
public enum rs2_timestamp_domain {
    ...
    private rs2_timestamp_domain(int v) { this.value = v; }
    private rs2_timestamp_domain(rs2_timestamp_domain e) { this.value = e.value; }
    public rs2_timestamp_domain intern() { for (rs2_timestamp_domain e : values()) if (e.value == value) return e; return this; }
    @Override public String toString() { return intern().name(); }
}
public static native @Cast("const char*") BytePointer rs2_timestamp_domain_to_string(rs2_timestamp_domain info);

/** \brief Per-Frame-Metadata is the set of read-only properties that might be exposed for each individual frame. */
public enum rs2_frame_metadata_value {
    ...
    public final int value;
    private rs2_frame_metadata_value(int v) { this.value = v; }
    private rs2_frame_metadata_value(rs2_frame_metadata_value e) { this.value = e.value; }
    public rs2_frame_metadata_value intern() { for (rs2_frame_metadata_value e : values()) if (e.value == value) return e; return this; }
    @Override public String toString() { return intern().name(); }
}
public static native @Cast("const char*") BytePointer rs2_frame_metadata_to_string(rs2_frame_metadata_value metadata);
public static native @Cast("const char*") BytePointer rs2_frame_metadata_value_to_string(rs2_frame_metadata_value metadata);
...
*/
public static native double rs2_get_frame_metadata(@Const rs2_frame frame, rs2_frame_metadata_value frame_metadata, @Cast("rs2_error**") PointerPointer error);
public static native double rs2_get_frame_metadata(@Const rs2_frame frame, rs2_frame_metadata_value frame_metadata, @ByPtrPtr rs2_error error);
...
*/
public static native int rs2_supports_frame_metadata(@Const rs2_frame frame, rs2_frame_metadata_value frame_metadata, @Cast("rs2_error**") PointerPointer error);
public static native int rs2_supports_frame_metadata(@Const rs2_frame frame, rs2_frame_metadata_value frame_metadata, @ByPtrPtr rs2_error error);
...
*/
public static native rs2_timestamp_domain rs2_get_frame_timestamp_domain(@Const rs2_frame frameset, @Cast("rs2_error**") PointerPointer error);
public static native rs2_timestamp_domain rs2_get_frame_timestamp_domain(@Const rs2_frame frameset, @ByPtrPtr rs2_error error);
...
*/
public static native double rs2_get_frame_timestamp(@Const rs2_frame frame, @Cast("rs2_error**") PointerPointer error);
public static native double rs2_get_frame_timestamp(@Const rs2_frame frame, @ByPtrPtr rs2_error error);
...
*/
public static native int rs2_is_frame_extendable_to(@Const rs2_frame frame, rs2_extension extension_type, @Cast("rs2_error**") PointerPointer error);
public static native int rs2_is_frame_extendable_to(@Const rs2_frame frame, rs2_extension extension_type, @ByPtrPtr rs2_error error);
...
public static native rs2_frame rs2_allocate_synthetic_video_frame(rs2_source source, @Const rs2_stream_profile new_stream, rs2_frame original,
    int new_bpp, int new_width, int new_height, int new_stride, rs2_extension frame_type, @Cast("rs2_error**") PointerPointer error);
public static native rs2_frame rs2_allocate_synthetic_video_frame(rs2_source source, @Const rs2_stream_profile new_stream, rs2_frame original,
    int new_bpp, int new_width, int new_height, int new_stride, rs2_extension frame_type, @ByPtrPtr rs2_error error);
...
// Parsed from /Users/cansik/git/private/librealsense-java/librealsense/include/librealsense2/h/rs_internal.h
 ...
 */
public enum rs2_recording_mode {
    RS2_RECORDING_MODE_BLANK_FRAMES(0), /* frame metadata will be recorded, but pixel data will be replaced with zeros to save space */
    RS2_RECORDING_MODE_COMPRESSED(1),   /* frames will be encoded using a proprietary lossy encoding, aiming at x5 compression at some CPU expense */
    RS2_RECORDING_MODE_BEST_QUALITY(2), /* frames will not be compressed, but rather stored as-is. This gives best quality and low CPU overhead, but you might run out of memory */
    RS2_RECORDING_MODE_COUNT(3);

    public final int value;
    private rs2_recording_mode(int v) { this.value = v; }
    private rs2_recording_mode(rs2_recording_mode e) { this.value = e.value; }
    public rs2_recording_mode intern() { for (rs2_recording_mode e : values()) if (e.value == value) return e; return this; }
    @Override public String toString() { return intern().name(); }
}

/** \brief All the parameters are required to define video stream*/
public static class rs2_video_stream extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
    public rs2_video_stream() { super((Pointer)null); allocate(); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public rs2_video_stream(long size) { super((Pointer)null); allocateArray(size); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public rs2_video_stream(Pointer p) { super(p); }
    private native void allocate();
    private native void allocateArray(long size);
    @Override public rs2_video_stream position(long position) {
        return (rs2_video_stream)super.position(position);
    }

    public native rs2_stream type(); public native rs2_video_stream type(rs2_stream setter);
    public native int index(); public native rs2_video_stream index(int setter);
    public native int uid(); public native rs2_video_stream uid(int setter);
    public native int width(); public native rs2_video_stream width(int setter);
    public native int height(); public native rs2_video_stream height(int setter);
    public native int fps(); public native rs2_video_stream fps(int setter);
    public native int bpp(); public native rs2_video_stream bpp(int setter);
    public native rs2_format fmt(); public native rs2_video_stream fmt(rs2_format setter);
    public native @ByRef rs2_intrinsics intrinsics(); public native rs2_video_stream intrinsics(rs2_intrinsics setter);
}

/** \brief All the parameters are required to define motion stream*/
public static class rs2_motion_stream extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
    public rs2_motion_stream() { super((Pointer)null); allocate(); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public rs2_motion_stream(long size) { super((Pointer)null); allocateArray(size); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public rs2_motion_stream(Pointer p) { super(p); }
    private native void allocate();
    private native void allocateArray(long size);
    @Override public rs2_motion_stream position(long position) {
        return (rs2_motion_stream)super.position(position);
    }

    public native rs2_stream type(); public native rs2_motion_stream type(rs2_stream setter);
    public native int index(); public native rs2_motion_stream index(int setter);
    public native int uid(); public native rs2_motion_stream uid(int setter);
    public native int fps(); public native rs2_motion_stream fps(int setter);
    public native rs2_format fmt(); public native rs2_motion_stream fmt(rs2_format setter);
    public native @ByRef rs2_motion_device_intrinsic intrinsics(); public native rs2_motion_stream intrinsics(rs2_motion_device_intrinsic setter);
}

/** \brief All the parameters are required to define pose stream*/
public static class rs2_pose_stream extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
    public rs2_pose_stream() { super((Pointer)null); allocate(); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public rs2_pose_stream(long size) { super((Pointer)null); allocateArray(size); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public rs2_pose_stream(Pointer p) { super(p); }
    private native void allocate();
    private native void allocateArray(long size);
    @Override public rs2_pose_stream position(long position) {
        return (rs2_pose_stream)super.position(position);
    }

    public native rs2_stream type(); public native rs2_pose_stream type(rs2_stream setter);
    public native int index(); public native rs2_pose_stream index(int setter);
    public native int uid(); public native rs2_pose_stream uid(int setter);
    public native int fps(); public native rs2_pose_stream fps(int setter);
    public native rs2_format fmt(); public native rs2_pose_stream fmt(rs2_format setter);
}

/** \brief All the parameters are required to define video frame*/
public static class rs2_software_video_frame extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
    public rs2_software_video_frame() { super((Pointer)null); allocate(); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public rs2_software_video_frame(long size) { super((Pointer)null); allocateArray(size); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public rs2_software_video_frame(Pointer p) { super(p); }
    private native void allocate();
    private native void allocateArray(long size);
    @Override public rs2_software_video_frame position(long position) {
        return (rs2_software_video_frame)super.position(position);
    }

    public native Pointer pixels(); public native rs2_software_video_frame pixels(Pointer setter);
    public static class Deleter_Pointer extends FunctionPointer {
        static { Loader.load(); }
        /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
        public    Deleter_Pointer(Pointer p) { super(p); }
        protected Deleter_Pointer() { allocate(); }
        private native void allocate();
        public native void call(Pointer arg0);
    }
    public native Deleter_Pointer deleter(); public native rs2_software_video_frame deleter(Deleter_Pointer setter);
    public native int stride(); public native rs2_software_video_frame stride(int setter);
    public native int bpp(); public native rs2_software_video_frame bpp(int setter);
    public native double timestamp(); public native rs2_software_video_frame timestamp(double setter);
    public native rs2_timestamp_domain domain(); public native rs2_software_video_frame domain(rs2_timestamp_domain setter);
    public native int frame_number(); public native rs2_software_video_frame frame_number(int setter);
    public native @Const rs2_stream_profile profile(); public native rs2_software_video_frame profile(rs2_stream_profile setter);
}

/** \brief All the parameters are required to define motion frame*/
public static class rs2_software_motion_frame extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
    public rs2_software_motion_frame() { super((Pointer)null); allocate(); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public rs2_software_motion_frame(long size) { super((Pointer)null); allocateArray(size); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public rs2_software_motion_frame(Pointer p) { super(p); }
    private native void allocate();
    private native void allocateArray(long size);
    @Override public rs2_software_motion_frame position(long position) {
        return (rs2_software_motion_frame)super.position(position);
    }

    public native Pointer data(); public native rs2_software_motion_frame data(Pointer setter);
    public static class Deleter_Pointer extends FunctionPointer {
        static { Loader.load(); }
        /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
        public    Deleter_Pointer(Pointer p) { super(p); }
    ...
    public native Deleter_Pointer deleter(); public native rs2_software_motion_frame deleter(Deleter_Pointer setter);
    public native double timestamp(); public native rs2_software_motion_frame timestamp(double setter);
    public native rs2_timestamp_domain domain(); public native rs2_software_motion_frame domain(rs2_timestamp_domain setter);
    public native int frame_number(); public native rs2_software_motion_frame frame_number(int setter);
    public native @Const rs2_stream_profile profile(); public native rs2_software_motion_frame profile(rs2_stream_profile setter);
}

/** \brief All the parameters are required to define pose frame*/
public static class rs2_software_pose_frame extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
    public rs2_software_pose_frame() { super((Pointer)null); allocate(); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public rs2_software_pose_frame(long size) { super((Pointer)null); allocateArray(size); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public rs2_software_pose_frame(Pointer p) { super(p); }
    private native void allocate();
    private native void allocateArray(long size);
    @Override public rs2_software_pose_frame position(long position) {
        return (rs2_software_pose_frame)super.position(position);
    }

    public static class pose_frame_info extends Pointer {
        static { Loader.load(); }
        /** Default native constructor. */
        public pose_frame_info() { super((Pointer)null); allocate(); }
        /** Native array allocator. Access with {@link Pointer#position(long)}. */
        public pose_frame_info(long size) { super((Pointer)null); allocateArray(size); }
        /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
        public pose_frame_info(Pointer p) { super(p); }
        private native void allocate();
        private native void allocateArray(long size);
        @Override public pose_frame_info position(long position) {
            return (pose_frame_info)super.position(position);
        }
    
        public native float translation(int i); public native pose_frame_info translation(int i, float setter);
        @MemberGetter public native FloatPointer translation();
        public native float velocity(int i); public native pose_frame_info velocity(int i, float setter);
        @MemberGetter public native FloatPointer velocity();
        public native float acceleration(int i); public native pose_frame_info acceleration(int i, float setter);
        @MemberGetter public native FloatPointer acceleration();
        public native float rotation(int i); public native pose_frame_info rotation(int i, float setter);
        @MemberGetter public native FloatPointer rotation();
        public native float angular_velocity(int i); public native pose_frame_info angular_velocity(int i, float setter);
        @MemberGetter public native FloatPointer angular_velocity();
        public native float angular_acceleration(int i); public native pose_frame_info angular_acceleration(int i, float setter);
        @MemberGetter public native FloatPointer angular_acceleration();
        public native int tracker_confidence(); public native pose_frame_info tracker_confidence(int setter);
        public native int mapper_confidence(); public native pose_frame_info mapper_confidence(int setter);
    }
    public native Pointer data(); public native rs2_software_pose_frame data(Pointer setter);
    public static class Deleter_Pointer extends FunctionPointer {
        static { Loader.load(); }
        /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
        public    Deleter_Pointer(Pointer p) { super(p); }
    ...
    public native Deleter_Pointer deleter(); public native rs2_software_pose_frame deleter(Deleter_Pointer setter);
    public native double timestamp(); public native rs2_software_pose_frame timestamp(double setter);
    public native rs2_timestamp_domain domain(); public native rs2_software_pose_frame domain(rs2_timestamp_domain setter);
    public native int frame_number(); public native rs2_software_pose_frame frame_number(int setter);
    public native @Const rs2_stream_profile profile(); public native rs2_software_pose_frame profile(rs2_stream_profile setter);
}

/**
 * Create librealsense context that will try to record all operations over librealsense into a file
 * @param api_version [in] realsense API version as provided by RS2_API_VERSION macro
 * @param filename [in] string representing the name of the file to record
 * @param section [in]  string representing the name of the section within existing recording
 * @param error [out]  if non-null, receives any error that occurs during this call, otherwise, errors are ignored
 * @return            context object, should be released by rs2_delete_context
 */
public static native rs2_context rs2_create_recording_context(int api_version, @Cast("const char*") BytePointer filename, @Cast("const char*") BytePointer section, rs2_recording_mode mode, @Cast("rs2_error**") PointerPointer error);
public static native rs2_context rs2_create_recording_context(int api_version, @Cast("const char*") BytePointer filename, @Cast("const char*") BytePointer section, rs2_recording_mode mode, @ByPtrPtr rs2_error error);
public static native rs2_context rs2_create_recording_context(int api_version, String filename, String section, rs2_recording_mode mode, @ByPtrPtr rs2_error error);
 ...
 * @param api_version [in] realsense API version as provided by RS2_API_VERSION macro
 * @param filename [in] string representing the name of the file to play back from
 * @param section [in]  string representing the name of the section within existing recording
 * @param error [out]  if non-null, receives any error that occurs during this call, otherwise, errors are ignored
 * @return            context object, should be released by rs2_delete_context
 */
public static native rs2_context rs2_create_mock_context(int api_version, @Cast("const char*") BytePointer filename, @Cast("const char*") BytePointer section, @Cast("rs2_error**") PointerPointer error);
public static native rs2_context rs2_create_mock_context(int api_version, @Cast("const char*") BytePointer filename, @Cast("const char*") BytePointer section, @ByPtrPtr rs2_error error);
public static native rs2_context rs2_create_mock_context(int api_version, String filename, String section, @ByPtrPtr rs2_error error);
...
* @param filename [in] string representing the name of the file to play back from
* @param section [in]  string representing the name of the section within existing recording
* @param min_api_version [in] reject any file that was recorded before this version
* @param error [out]  if non-null, receives any error that occurs during this call, otherwise, errors are ignored
* @return            context object, should be released by rs2_delete_context
*/
public static native rs2_context rs2_create_mock_context_versioned(int api_version, @Cast("const char*") BytePointer filename, @Cast("const char*") BytePointer section, @Cast("const char*") BytePointer min_api_version, @Cast("rs2_error**") PointerPointer error);
public static native rs2_context rs2_create_mock_context_versioned(int api_version, @Cast("const char*") BytePointer filename, @Cast("const char*") BytePointer section, @Cast("const char*") BytePointer min_api_version, @ByPtrPtr rs2_error error);
public static native rs2_context rs2_create_mock_context_versioned(int api_version, String filename, String section, String min_api_version, @ByPtrPtr rs2_error error);
 ...
 */
public static native rs2_device rs2_create_software_device(@Cast("rs2_error**") PointerPointer error);
public static native rs2_device rs2_create_software_device(@ByPtrPtr rs2_error error);

/**
 * Add sensor to the software device
 * @param dev [in] the software device
 * @param sensor_name [in] the name of the sensor
 * @param error [out]  if non-null, receives any error that occurs during this call, otherwise, errors are ignored
 * @return            software sensor object, should be released by rs2_delete_sensor
 */
public static native rs2_sensor rs2_software_device_add_sensor(rs2_device dev, @Cast("const char*") BytePointer sensor_name, @Cast("rs2_error**") PointerPointer error);
public static native rs2_sensor rs2_software_device_add_sensor(rs2_device dev, @Cast("const char*") BytePointer sensor_name, @ByPtrPtr rs2_error error);
public static native rs2_sensor rs2_software_device_add_sensor(rs2_device dev, String sensor_name, @ByPtrPtr rs2_error error);

/**
 * Inject video frame to software sonsor
 * @param sensor [in] the software sensor
 * @param frame [in] all the frame components
 * @param error [out]  if non-null, receives any error that occurs during this call, otherwise, errors are ignored
 */
public static native void rs2_software_sensor_on_video_frame(rs2_sensor sensor, @ByVal rs2_software_video_frame frame, @Cast("rs2_error**") PointerPointer error);
public static native void rs2_software_sensor_on_video_frame(rs2_sensor sensor, @ByVal rs2_software_video_frame frame, @ByPtrPtr rs2_error error);
...
* @param error [out]  if non-null, receives any error that occurs during this call, otherwise, errors are ignored
*/
public static native void rs2_software_sensor_on_motion_frame(rs2_sensor sensor, @ByVal rs2_software_motion_frame frame, @Cast("rs2_error**") PointerPointer error);
public static native void rs2_software_sensor_on_motion_frame(rs2_sensor sensor, @ByVal rs2_software_motion_frame frame, @ByPtrPtr rs2_error error);
...
* @param error [out]  if non-null, receives any error that occurs during this call, otherwise, errors are ignored
*/
public static native void rs2_software_sensor_on_pose_frame(rs2_sensor sensor, @ByVal rs2_software_pose_frame frame, @Cast("rs2_error**") PointerPointer error);
public static native void rs2_software_sensor_on_pose_frame(rs2_sensor sensor, @ByVal rs2_software_pose_frame frame, @ByPtrPtr rs2_error error);

/**
* Set frame metadata for the upcoming frames
* @param sensor [in] the software sensor
* @param value [in] metadata key to set
* @param type [in] metadata value
* @param error [out]  if non-null, receives any error that occurs during this call, otherwise, errors are ignored
*/
public static native void rs2_software_sensor_set_metadata(rs2_sensor sensor, rs2_frame_metadata_value value, double type, @Cast("rs2_error**") PointerPointer error);
public static native void rs2_software_sensor_set_metadata(rs2_sensor sensor, rs2_frame_metadata_value value, double type, @ByPtrPtr rs2_error error);

/**
 * Set the wanted matcher type that will be used by the syncer
 * @param dev [in] the software device
 * @param matcher [in] matcher type
 * @param error [out]  if non-null, receives any error that occurs during this call, otherwise, errors are ignored
 */
public static native void rs2_software_device_create_matcher(rs2_device dev, rs2_matchers matcher, @Cast("rs2_error**") PointerPointer error);
public static native void rs2_software_device_create_matcher(rs2_device dev, rs2_matchers matcher, @ByPtrPtr rs2_error error);

/**
 * Add video stream to sensor
 * @param sensor [in] the software sensor
 * @param video_stream [in] all the stream components
 * @param error [out]  if non-null, receives any error that occurs during this call, otherwise, errors are ignored
 */
public static native rs2_stream_profile rs2_software_sensor_add_video_stream(rs2_sensor sensor, @ByVal rs2_video_stream video_stream, @Cast("rs2_error**") PointerPointer error);
public static native rs2_stream_profile rs2_software_sensor_add_video_stream(rs2_sensor sensor, @ByVal rs2_video_stream video_stream, @ByPtrPtr rs2_error error);
...
* @param error [out]  if non-null, receives any error that occurs during this call, otherwise, errors are ignored
*/
public static native rs2_stream_profile rs2_software_sensor_add_motion_stream(rs2_sensor sensor, @ByVal rs2_motion_stream motion_stream, @Cast("rs2_error**") PointerPointer error);
public static native rs2_stream_profile rs2_software_sensor_add_motion_stream(rs2_sensor sensor, @ByVal rs2_motion_stream motion_stream, @ByPtrPtr rs2_error error);
...
* @param error [out]  if non-null, receives any error that occurs during this call, otherwise, errors are ignored
*/
public static native rs2_stream_profile rs2_software_sensor_add_pose_stream(rs2_sensor sensor, @ByVal rs2_pose_stream pose_stream, @Cast("rs2_error**") PointerPointer error);
public static native rs2_stream_profile rs2_software_sensor_add_pose_stream(rs2_sensor sensor, @ByVal rs2_pose_stream pose_stream, @ByPtrPtr rs2_error error);

/**
 * Add read only option to sensor
 * @param sensor [in] the software sensor
 * @param option [in] the wanted option
 * @param val [in] the initial value
 * @param error [out]  if non-null, receives any error that occurs during this call, otherwise, errors are ignored
 */
public static native void rs2_software_sensor_add_read_only_option(rs2_sensor sensor, rs2_option option, float val, @Cast("rs2_error**") PointerPointer error);
public static native void rs2_software_sensor_add_read_only_option(rs2_sensor sensor, rs2_option option, float val, @ByPtrPtr rs2_error error);

/**
 * Update the read only option added to sensor
 * @param sensor [in] the software sensor
 * @param option [in] the wanted option
 * @param val [in] the wanted value
 * @param error [out]  if non-null, receives any error that occurs during this call, otherwise, errors are ignored
 */
public static native void rs2_software_sensor_update_read_only_option(rs2_sensor sensor, rs2_option option, float val, @Cast("rs2_error**") PointerPointer error);
public static native void rs2_software_sensor_update_read_only_option(rs2_sensor sensor, rs2_option option, float val, @ByPtrPtr rs2_error error);
// #ifdef __cplusplus
// #endif
// #endif


// Parsed from /Users/cansik/git/private/librealsense-java/librealsense/include/librealsense2/h/rs_option.h
...
// #include "rs_types.h"
    ...
    */
    public enum rs2_option {
        ...
        public final int value;
        private rs2_option(int v) { this.value = v; }
        private rs2_option(rs2_option e) { this.value = e.value; }
        public rs2_option intern() { for (rs2_option e : values()) if (e.value == value) return e; return this; }
        @Override public String toString() { return intern().name(); }
    }
    ...
    public static native @Cast("const char*") BytePointer rs2_option_to_string(rs2_option option);

    /** \brief For SR300 devices: provides optimized settings (presets) for specific types of usage. */
    public enum rs2_sr300_visual_preset {
        ...
        public final int value;
        private rs2_sr300_visual_preset(int v) { this.value = v; }
        private rs2_sr300_visual_preset(rs2_sr300_visual_preset e) { this.value = e.value; }
        public rs2_sr300_visual_preset intern() { for (rs2_sr300_visual_preset e : values()) if (e.value == value) return e; return this; }
        @Override public String toString() { return intern().name(); }
    }
    public static native @Cast("const char*") BytePointer rs2_sr300_visual_preset_to_string(rs2_sr300_visual_preset preset);
    ...
    */
    public static native int rs2_is_option_read_only(@Const rs2_options options, rs2_option option, @Cast("rs2_error**") PointerPointer error);
    public static native int rs2_is_option_read_only(@Const rs2_options options, rs2_option option, @ByPtrPtr rs2_error error);
    ...
    */
    public static native float rs2_get_option(@Const rs2_options options, rs2_option option, @Cast("rs2_error**") PointerPointer error);
    public static native float rs2_get_option(@Const rs2_options options, rs2_option option, @ByPtrPtr rs2_error error);
    ...
    * @param error [out]     if non-null, receives any error that occurs during this call, otherwise, errors are ignored
    */
    public static native void rs2_set_option(@Const rs2_options options, rs2_option option, float value, @Cast("rs2_error**") PointerPointer error);
    public static native void rs2_set_option(@Const rs2_options options, rs2_option option, float value, @ByPtrPtr rs2_error error);
   ...
   */
    ...
    */
    public static native @Cast("const char*") BytePointer rs2_get_option_name(@Const rs2_options options, rs2_option option, @Cast("rs2_error**") PointerPointer error);
    public static native @Cast("const char*") BytePointer rs2_get_option_name(@Const rs2_options options, rs2_option option, @ByPtrPtr rs2_error error);
   ...
   * @param error [out]     if non-null, receives any error that occurs during this call, otherwise, errors are ignored
   */
    public static native rs2_option rs2_get_option_from_list(@Const rs2_options_list options, int i, @Cast("rs2_error**") PointerPointer error);
    public static native rs2_option rs2_get_option_from_list(@Const rs2_options_list options, int i, @ByPtrPtr rs2_error error);
    ...
    */
    public static native int rs2_supports_option(@Const rs2_options options, rs2_option option, @Cast("rs2_error**") PointerPointer error);
    public static native int rs2_supports_option(@Const rs2_options options, rs2_option option, @ByPtrPtr rs2_error error);
    ...
    * @param error [out]  if non-null, receives any error that occurs during this call, otherwise, errors are ignored
    */
    public static native void rs2_get_option_range(@Const rs2_options sensor, rs2_option option, FloatPointer min, FloatPointer max, FloatPointer step, FloatPointer def, @Cast("rs2_error**") PointerPointer error);
    public static native void rs2_get_option_range(@Const rs2_options sensor, rs2_option option, FloatPointer min, FloatPointer max, FloatPointer step, FloatPointer def, @ByPtrPtr rs2_error error);
    public static native void rs2_get_option_range(@Const rs2_options sensor, rs2_option option, FloatBuffer min, FloatBuffer max, FloatBuffer step, FloatBuffer def, @ByPtrPtr rs2_error error);
    public static native void rs2_get_option_range(@Const rs2_options sensor, rs2_option option, float[] min, float[] max, float[] step, float[] def, @ByPtrPtr rs2_error error);
    ...
    */
    public static native @Cast("const char*") BytePointer rs2_get_option_description(@Const rs2_options options, rs2_option option, @Cast("rs2_error**") PointerPointer error);
    public static native @Cast("const char*") BytePointer rs2_get_option_description(@Const rs2_options options, rs2_option option, @ByPtrPtr rs2_error error);
    ...
    */
    public static native @Cast("const char*") BytePointer rs2_get_option_value_description(@Const rs2_options options, rs2_option option, float value, @Cast("rs2_error**") PointerPointer error);
    public static native @Cast("const char*") BytePointer rs2_get_option_value_description(@Const rs2_options options, rs2_option option, float value, @ByPtrPtr rs2_error error);
...
// Parsed from /Users/cansik/git/private/librealsense-java/librealsense/include/librealsense2/h/rs_pipeline.h
...
// #include "rs_config.h"
    ...
    * @return             The actual pipeline device and streams profile, which was successfully configured to the streaming device.
    */
    public static native rs2_pipeline_profile rs2_pipeline_start_with_callback(rs2_pipeline pipe, @ByVal rs2_frame_callback_ptr on_frame, Pointer user, @Cast("rs2_error**") PointerPointer error);
    public static native rs2_pipeline_profile rs2_pipeline_start_with_callback(rs2_pipeline pipe, @ByVal rs2_frame_callback_ptr on_frame, Pointer user, @ByPtrPtr rs2_error error);
    ...
    * @return             The actual pipeline device and streams profile, which was successfully configured to the streaming device.
    */
    public static native rs2_pipeline_profile rs2_pipeline_start_with_config_and_callback(rs2_pipeline pipe, rs2_config config, @ByVal rs2_frame_callback_ptr on_frame, Pointer user, @Cast("rs2_error**") PointerPointer error);
    public static native rs2_pipeline_profile rs2_pipeline_start_with_config_and_callback(rs2_pipeline pipe, rs2_config config, @ByVal rs2_frame_callback_ptr on_frame, Pointer user, @ByPtrPtr rs2_error error);
...
// Parsed from /Users/cansik/git/private/librealsense-java/librealsense/include/librealsense2/h/rs_processing.h
...
* @return           new processing block, to be released by rs2_delete_processing_block
*/
public static native rs2_processing_block rs2_create_processing_block_fptr(@ByVal rs2_frame_processor_callback_ptr proc, Pointer context, @Cast("rs2_error**") PointerPointer error);
public static native rs2_processing_block rs2_create_processing_block_fptr(@ByVal rs2_frame_processor_callback_ptr proc, Pointer context, @ByPtrPtr rs2_error error);
...
*/
public static native int rs2_processing_block_register_simple_option(rs2_processing_block block, rs2_option option_id, float min, float max, float step, float def, @Cast("rs2_error**") PointerPointer error);
public static native int rs2_processing_block_register_simple_option(rs2_processing_block block, rs2_option option_id, float min, float max, float step, float def, @ByPtrPtr rs2_error error);
...
* @param error [out]  if non-null, receives any error that occurs during this call, otherwise, errors are ignored
*/
public static native void rs2_start_processing_fptr(rs2_processing_block block, @ByVal rs2_frame_callback_ptr on_frame, Pointer user, @Cast("rs2_error**") PointerPointer error);
public static native void rs2_start_processing_fptr(rs2_processing_block block, @ByVal rs2_frame_callback_ptr on_frame, Pointer user, @ByPtrPtr rs2_error error);
...
* @param error [out]  if non-null, receives any error that occurs during this call, otherwise, errors are ignored
*/
public static native rs2_processing_block rs2_create_align(rs2_stream align_to, @Cast("rs2_error**") PointerPointer error);
public static native rs2_processing_block rs2_create_align(rs2_stream align_to, @ByPtrPtr rs2_error error);
...
*/
public static native @Cast("const char*") BytePointer rs2_get_processing_block_info(@Const rs2_processing_block block, rs2_camera_info info, @Cast("rs2_error**") PointerPointer error);
public static native @Cast("const char*") BytePointer rs2_get_processing_block_info(@Const rs2_processing_block block, rs2_camera_info info, @ByPtrPtr rs2_error error);
...
* @return               True if the parameter both exist and well-defined for the specific device
*/
public static native int rs2_supports_processing_block_info(@Const rs2_processing_block block, rs2_camera_info info, @Cast("rs2_error**") PointerPointer error);
public static native int rs2_supports_processing_block_info(@Const rs2_processing_block block, rs2_camera_info info, @ByPtrPtr rs2_error error);
 ...
 */
public static native int rs2_is_processing_block_extendable_to(@Const rs2_processing_block block, rs2_extension extension_type, @Cast("rs2_error**") PointerPointer error);
public static native int rs2_is_processing_block_extendable_to(@Const rs2_processing_block block, rs2_extension extension_type, @ByPtrPtr rs2_error error);
...
// Parsed from /Users/cansik/git/private/librealsense-java/librealsense/include/librealsense2/h/rs_record_playback.h
...
public enum rs2_playback_status {
    /** Unknown state */
    ...
    public final int value;
    private rs2_playback_status(int v) { this.value = v; }
    private rs2_playback_status(rs2_playback_status e) { this.value = e.value; }
    public rs2_playback_status intern() { for (rs2_playback_status e : values()) if (e.value == value) return e; return this; }
    @Override public String toString() { return intern().name(); }
}

public static native @Cast("const char*") BytePointer rs2_playback_status_to_string(rs2_playback_status status);

public static class rs2_playback_status_changed_callback_ptr extends FunctionPointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public    rs2_playback_status_changed_callback_ptr(Pointer p) { super(p); }
    protected rs2_playback_status_changed_callback_ptr() { allocate(); }
    private native void allocate();
    public native void call(rs2_playback_status arg0);
}
...
* @return A pointer to a device that plays data from the file, or null in case of failure
*/
public static native rs2_device rs2_create_playback_device(@Cast("const char*") BytePointer file, @Cast("rs2_error**") PointerPointer error);
public static native rs2_device rs2_create_playback_device(@Cast("const char*") BytePointer file, @ByPtrPtr rs2_error error);
public static native rs2_device rs2_create_playback_device(String file, @ByPtrPtr rs2_error error);
 ...
 */
public static native rs2_playback_status rs2_playback_device_get_current_status(@Const rs2_device device, @Cast("rs2_error**") PointerPointer error);
public static native rs2_playback_status rs2_playback_device_get_current_status(@Const rs2_device device, @ByPtrPtr rs2_error error);
...
// Parsed from /Users/cansik/git/private/librealsense-java/librealsense/include/librealsense2/h/rs_sensor.h
...
public enum rs2_camera_info {
    ...
    public final int value;
    private rs2_camera_info(int v) { this.value = v; }
    private rs2_camera_info(rs2_camera_info e) { this.value = e.value; }
    public rs2_camera_info intern() { for (rs2_camera_info e : values()) if (e.value == value) return e; return this; }
    @Override public String toString() { return intern().name(); }
}
public static native @Cast("const char*") BytePointer rs2_camera_info_to_string(rs2_camera_info info);

/** \brief Streams are different types of data provided by RealSense devices. */
public enum rs2_stream {
    RS2_STREAM_ANY(0),
    ...
    public final int value;
    private rs2_stream(int v) { this.value = v; }
    private rs2_stream(rs2_stream e) { this.value = e.value; }
    public rs2_stream intern() { for (rs2_stream e : values()) if (e.value == value) return e; return this; }
    @Override public String toString() { return intern().name(); }
}
public static native @Cast("const char*") BytePointer rs2_stream_to_string(rs2_stream stream);

/** \brief A stream's format identifies how binary data is encoded within a frame. */
public enum rs2_format {
    ...
    public final int value;
    private rs2_format(int v) { this.value = v; }
    private rs2_format(rs2_format e) { this.value = e.value; }
    public rs2_format intern() { for (rs2_format e : values()) if (e.value == value) return e; return this; }
    @Override public String toString() { return intern().name(); }
}
public static native @Cast("const char*") BytePointer rs2_format_to_string(rs2_format format);

/** \brief Cross-stream extrinsics: encodes the topology describing how the different devices are oriented. */
public static class rs2_extrinsics extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
...
* @return               the requested camera info string, in a format specific to the device model
*/
public static native @Cast("const char*") BytePointer rs2_get_sensor_info(@Const rs2_sensor sensor, rs2_camera_info info, @Cast("rs2_error**") PointerPointer error);
public static native @Cast("const char*") BytePointer rs2_get_sensor_info(@Const rs2_sensor sensor, rs2_camera_info info, @ByPtrPtr rs2_error error);
...
* @return                true if the parameter both exist and well-defined for the specific device
*/
public static native int rs2_supports_sensor_info(@Const rs2_sensor sensor, rs2_camera_info info, @Cast("rs2_error**") PointerPointer error);
public static native int rs2_supports_sensor_info(@Const rs2_sensor sensor, rs2_camera_info info, @ByPtrPtr rs2_error error);
 ...
 */
public static native int rs2_is_sensor_extendable_to(@Const rs2_sensor sensor, rs2_extension extension, @Cast("rs2_error**") PointerPointer error);
public static native int rs2_is_sensor_extendable_to(@Const rs2_sensor sensor, rs2_extension extension, @ByPtrPtr rs2_error error);
...
* @param error [out]  if non-null, receives any error that occurs during this call, otherwise, errors are ignored
*/
public static native void rs2_start(@Const rs2_sensor sensor, @ByVal rs2_frame_callback_ptr on_frame, Pointer user, @Cast("rs2_error**") PointerPointer error);
public static native void rs2_start(@Const rs2_sensor sensor, @ByVal rs2_frame_callback_ptr on_frame, Pointer user, @ByPtrPtr rs2_error error);
...
* @param error [out]          if non-null, receives any error that occurs during this call, otherwise, errors are ignored
*/
public static native void rs2_set_notifications_callback(@Const rs2_sensor sensor, @ByVal rs2_notification_callback_ptr on_notification, Pointer user, @Cast("rs2_error**") PointerPointer error);
public static native void rs2_set_notifications_callback(@Const rs2_sensor sensor, @ByVal rs2_notification_callback_ptr on_notification, Pointer user, @ByPtrPtr rs2_error error);
...
*/
public static native double rs2_get_notification_timestamp(rs2_notification notification, @Cast("rs2_error**") PointerPointer error);
public static native double rs2_get_notification_timestamp(rs2_notification notification, @ByPtrPtr rs2_error error);
...
*/
public static native rs2_log_severity rs2_get_notification_severity(rs2_notification notification, @Cast("rs2_error**") PointerPointer error);
public static native rs2_log_severity rs2_get_notification_severity(rs2_notification notification, @ByPtrPtr rs2_error error);
...
*/
public static native rs2_notification_category rs2_get_notification_category(rs2_notification notification, @Cast("rs2_error**") PointerPointer error);
public static native rs2_notification_category rs2_get_notification_category(rs2_notification notification, @ByPtrPtr rs2_error error);
...
* @param error [out]      if non-null, receives any error that occurs during this call, otherwise, errors are ignored
*/
public static native void rs2_get_stream_profile_data(@Const rs2_stream_profile mode, rs2_stream stream, rs2_format format, IntPointer index, IntPointer unique_id, IntPointer framerate, @Cast("rs2_error**") PointerPointer error);
public static native void rs2_get_stream_profile_data(@Const rs2_stream_profile mode, rs2_stream stream, rs2_format format, IntPointer index, IntPointer unique_id, IntPointer framerate, @ByPtrPtr rs2_error error);
public static native void rs2_get_stream_profile_data(@Const rs2_stream_profile mode, rs2_stream stream, rs2_format format, IntBuffer index, IntBuffer unique_id, IntBuffer framerate, @ByPtrPtr rs2_error error);
public static native void rs2_get_stream_profile_data(@Const rs2_stream_profile mode, rs2_stream stream, rs2_format format, int[] index, int[] unique_id, int[] framerate, @ByPtrPtr rs2_error error);
...
* @param error [out]      if non-null, receives any error that occurs during this call, otherwise, errors are ignored
*/
public static native void rs2_set_stream_profile_data(rs2_stream_profile mode, rs2_stream stream, int index, rs2_format format, @Cast("rs2_error**") PointerPointer error);
public static native void rs2_set_stream_profile_data(rs2_stream_profile mode, rs2_stream stream, int index, rs2_format format, @ByPtrPtr rs2_error error);
...
*/
public static native rs2_stream_profile rs2_clone_stream_profile(@Const rs2_stream_profile mode, rs2_stream stream, int index, rs2_format format, @Cast("rs2_error**") PointerPointer error);
public static native rs2_stream_profile rs2_clone_stream_profile(@Const rs2_stream_profile mode, rs2_stream stream, int index, rs2_format format, @ByPtrPtr rs2_error error);
...
*/
public static native int rs2_stream_profile_is(@Const rs2_stream_profile mode, rs2_extension type, @Cast("rs2_error**") PointerPointer error);
public static native int rs2_stream_profile_is(@Const rs2_stream_profile mode, rs2_extension type, @ByPtrPtr rs2_error error);
...
// Parsed from /Users/cansik/git/private/librealsense-java/librealsense/include/librealsense2/h/rs_types.h
...
public enum rs2_notification_category {
    ...
    public final int value;
    private rs2_notification_category(int v) { this.value = v; }
    private rs2_notification_category(rs2_notification_category e) { this.value = e.value; }
    public rs2_notification_category intern() { for (rs2_notification_category e : values()) if (e.value == value) return e; return this; }
    @Override public String toString() { return intern().name(); }
}
public static native @Cast("const char*") BytePointer rs2_notification_category_to_string(rs2_notification_category category);

/** \brief Exception types are the different categories of errors that RealSense API might return. */
public enum rs2_exception_type {
    ...
    public final int value;
    private rs2_exception_type(int v) { this.value = v; }
    private rs2_exception_type(rs2_exception_type e) { this.value = e.value; }
    public rs2_exception_type intern() { for (rs2_exception_type e : values()) if (e.value == value) return e; return this; }
    @Override public String toString() { return intern().name(); }
}
public static native @Cast("const char*") BytePointer rs2_exception_type_to_string(rs2_exception_type type);

/** \brief Distortion model: defines how pixel coordinates should be mapped to sensor coordinates. */
public enum rs2_distortion {
    ...
    public final int value;
    private rs2_distortion(int v) { this.value = v; }
    private rs2_distortion(rs2_distortion e) { this.value = e.value; }
    public rs2_distortion intern() { for (rs2_distortion e : values()) if (e.value == value) return e; return this; }
    @Override public String toString() { return intern().name(); }
}
public static native @Cast("const char*") BytePointer rs2_distortion_to_string(rs2_distortion distortion);

/** \brief Video stream intrinsics. */
public static class rs2_intrinsics extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
    ...
    public native rs2_distortion model(); public native rs2_intrinsics model(rs2_distortion setter);
...
public static class rs2_motion_device_intrinsic extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
...
public static class rs2_vertex extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
...
public static class rs2_pixel extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
...
public static class rs2_vector extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
...
public static class rs2_quaternion extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
...
public static class rs2_pose extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
...
public enum rs2_log_severity {
    ...
    public final int value;
    private rs2_log_severity(int v) { this.value = v; }
    private rs2_log_severity(rs2_log_severity e) { this.value = e.value; }
    public rs2_log_severity intern() { for (rs2_log_severity e : values()) if (e.value == value) return e; return this; }
    @Override public String toString() { return intern().name(); }
}
public static native @Cast("const char*") BytePointer rs2_log_severity_to_string(rs2_log_severity info);

/** \brief Specifies advanced interfaces (capabilities) objects may implement. */
public enum rs2_extension {
    ...
    RS2_EXTENSION_COUNT(37);

    public final int value;
    private rs2_extension(int v) { this.value = v; }
    private rs2_extension(rs2_extension e) { this.value = e.value; }
    public rs2_extension intern() { for (rs2_extension e : values()) if (e.value == value) return e; return this; }
    @Override public String toString() { return intern().name(); }
}
public static native @Cast("const char*") BytePointer rs2_extension_type_to_string(rs2_extension type);
public static native @Cast("const char*") BytePointer rs2_extension_to_string(rs2_extension type);

/** \brief Specifies types of different matchers */
public enum rs2_matchers {
   ...
   RS2_MATCHER_COUNT(7);
    ...
    public final int value;
    private rs2_matchers(int v) { this.value = v; }
    private rs2_matchers(rs2_matchers e) { this.value = e.value; }
    public rs2_matchers intern() { for (rs2_matchers e : values()) if (e.value == value) return e; return this; }
    @Override public String toString() { return intern().name(); }
}

@Opaque public static class rs2_device_info extends Pointer {
    /** Empty constructor. Calls {@code super((Pointer)null)}. */
    public rs2_device_info() { super((Pointer)null); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public rs2_device_info(Pointer p) { super(p); }
}
@Opaque public static class rs2_device extends Pointer {
    /** Empty constructor. Calls {@code super((Pointer)null)}. */
    public rs2_device() { super((Pointer)null); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public rs2_device(Pointer p) { super(p); }
}
@Opaque public static class rs2_error extends Pointer {
    /** Empty constructor. Calls {@code super((Pointer)null)}. */
    public rs2_error() { super((Pointer)null); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public rs2_error(Pointer p) { super(p); }
}
@Opaque public static class rs2_raw_data_buffer extends Pointer {
    /** Empty constructor. Calls {@code super((Pointer)null)}. */
    public rs2_raw_data_buffer() { super((Pointer)null); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public rs2_raw_data_buffer(Pointer p) { super(p); }
}
@Opaque public static class rs2_frame extends Pointer {
    /** Empty constructor. Calls {@code super((Pointer)null)}. */
    public rs2_frame() { super((Pointer)null); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public rs2_frame(Pointer p) { super(p); }
}
@Opaque public static class rs2_frame_queue extends Pointer {
    /** Empty constructor. Calls {@code super((Pointer)null)}. */
    public rs2_frame_queue() { super((Pointer)null); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public rs2_frame_queue(Pointer p) { super(p); }
}
@Opaque public static class rs2_pipeline extends Pointer {
    /** Empty constructor. Calls {@code super((Pointer)null)}. */
    public rs2_pipeline() { super((Pointer)null); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public rs2_pipeline(Pointer p) { super(p); }
}
@Opaque public static class rs2_pipeline_profile extends Pointer {
    /** Empty constructor. Calls {@code super((Pointer)null)}. */
    public rs2_pipeline_profile() { super((Pointer)null); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public rs2_pipeline_profile(Pointer p) { super(p); }
}
@Opaque public static class rs2_config extends Pointer {
    /** Empty constructor. Calls {@code super((Pointer)null)}. */
    public rs2_config() { super((Pointer)null); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public rs2_config(Pointer p) { super(p); }
}
@Opaque public static class rs2_device_list extends Pointer {
    /** Empty constructor. Calls {@code super((Pointer)null)}. */
    public rs2_device_list() { super((Pointer)null); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public rs2_device_list(Pointer p) { super(p); }
}
@Opaque public static class rs2_stream_profile_list extends Pointer {
    /** Empty constructor. Calls {@code super((Pointer)null)}. */
    public rs2_stream_profile_list() { super((Pointer)null); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public rs2_stream_profile_list(Pointer p) { super(p); }
}
@Opaque public static class rs2_processing_block_list extends Pointer {
    /** Empty constructor. Calls {@code super((Pointer)null)}. */
    public rs2_processing_block_list() { super((Pointer)null); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public rs2_processing_block_list(Pointer p) { super(p); }
}
@Opaque public static class rs2_stream_profile extends Pointer {
    /** Empty constructor. Calls {@code super((Pointer)null)}. */
    public rs2_stream_profile() { super((Pointer)null); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public rs2_stream_profile(Pointer p) { super(p); }
}
@Opaque public static class rs2_frame_callback extends Pointer {
    /** Empty constructor. Calls {@code super((Pointer)null)}. */
    public rs2_frame_callback() { super((Pointer)null); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public rs2_frame_callback(Pointer p) { super(p); }
}
@Opaque public static class rs2_log_callback extends Pointer {
    /** Empty constructor. Calls {@code super((Pointer)null)}. */
    public rs2_log_callback() { super((Pointer)null); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public rs2_log_callback(Pointer p) { super(p); }
}
@Opaque public static class rs2_syncer extends Pointer {
    /** Empty constructor. Calls {@code super((Pointer)null)}. */
    public rs2_syncer() { super((Pointer)null); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public rs2_syncer(Pointer p) { super(p); }
}
@Opaque public static class rs2_device_serializer extends Pointer {
    /** Empty constructor. Calls {@code super((Pointer)null)}. */
    public rs2_device_serializer() { super((Pointer)null); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public rs2_device_serializer(Pointer p) { super(p); }
}
@Opaque public static class rs2_source extends Pointer {
    /** Empty constructor. Calls {@code super((Pointer)null)}. */
    public rs2_source() { super((Pointer)null); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public rs2_source(Pointer p) { super(p); }
}
@Opaque public static class rs2_processing_block extends Pointer {
    /** Empty constructor. Calls {@code super((Pointer)null)}. */
    public rs2_processing_block() { super((Pointer)null); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public rs2_processing_block(Pointer p) { super(p); }
}
@Opaque public static class rs2_frame_processor_callback extends Pointer {
    /** Empty constructor. Calls {@code super((Pointer)null)}. */
    public rs2_frame_processor_callback() { super((Pointer)null); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public rs2_frame_processor_callback(Pointer p) { super(p); }
}
@Opaque public static class rs2_playback_status_changed_callback extends Pointer {
    /** Empty constructor. Calls {@code super((Pointer)null)}. */
...
@Opaque public static class rs2_notifications_callback extends Pointer {
    /** Empty constructor. Calls {@code super((Pointer)null)}. */
    public rs2_notifications_callback() { super((Pointer)null); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public rs2_notifications_callback(Pointer p) { super(p); }
}
public static class rs2_notification_callback_ptr extends FunctionPointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
...
public static class rs2_devices_changed_callback_ptr extends FunctionPointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public    rs2_devices_changed_callback_ptr(Pointer p) { super(p); }
    protected rs2_devices_changed_callback_ptr() { allocate(); }
    private native void allocate();
    public native void call(rs2_device_list arg0, rs2_device_list arg1, Pointer arg2);
}
...
public static class rs2_frame_processor_callback_ptr extends FunctionPointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
...
public static native rs2_error rs2_create_error(@Cast("const char*") BytePointer what, @Cast("const char*") BytePointer name, @Cast("const char*") BytePointer args, rs2_exception_type type);
public static native rs2_error rs2_create_error(String what, String name, String args, rs2_exception_type type);
public static native rs2_exception_type rs2_get_librealsense_exception_type(@Const rs2_error error);
